...
var Dialog = function() {
  ...
  return {
    init: function() {
      ...
      this.dialog_luckyzinc();
      this.dialog_carlosfalchi();
      this.dialog_carlosfalchi_teaser();
      this.dialog_coolercleanse();
      this.dialog_chilewich_wholesale();
      this.dialog_lucky_stylespotter();
      this.dialog_orsella();
      this.dialog_bond_and_bowery();
      this.dialog_chilewich();
      this.dialog_thornton();
      this.dialog_liz();
      this.dialog_citibabes();
    ...
    dialog_luckyzinc: function() {   
      ...
      $('#luckyzinc_opener').live('click', function() {
    	  Dialog.open('#luckyzinc');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#luckyzinc');
        return false;
      });
    },
    
    dialog_carlosfalchi: function() {   
      $('#carlosfalchi').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#carlosfalchi_opener').live('click', function() {
    	  Dialog.open('#carlosfalchi');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#carlosfalchi');
        return false;
      });
    },
    
    dialog_carlosfalchi_teaser: function() {   
      $('#carlosfalchi_teaser').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      	width: 780,
      ...
      $('#carlosfalchi_teaser_opener').live('click', function() {
    	  Dialog.open('#carlosfalchi_teaser');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#carlosfalchi_teaser');
        return false;
      });
    },
    
    dialog_coolercleanse: function() {   
      $('#coolercleanse').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      	width: 780,
      ...
      $('#coolercleanse_opener').live('click', function() {
    	  Dialog.open('#coolercleanse');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#coolercleanse');
        return false;
      });
    },
    
    dialog_chilewich_wholesale: function() {   
      $('#chilewich_wholesale').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      	width: 780,
      ...
      $('#chilewich_wholesale_opener').live('click', function() {
    	  Dialog.open('#chilewich_wholesale');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#chilewich_wholesale');
        return false;
      });
    },
    
    dialog_lucky_stylespotter: function() {   
      $('#lucky_stylespotter').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      	width: 780,
      ...
      $('#lucky_stylespotter_opener').live('click', function() {
    	  Dialog.open('#lucky_stylespotter');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#lucky_stylespotter');
        return false;
      });
    },

    dialog_orsella: function() {   
      $('#orsella').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#orsella_opener').live('click', function() {
    	  Dialog.open('#orsella');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#orsella');
        return false;
      });
    },
    
    dialog_bond_and_bowery: function() {   
      $('#bond_and_bowery').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      	width: 780,
      ...
      $('#bond_and_bowery_opener').live('click', function() {
    	  Dialog.open('#bond_and_bowery');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#bond_and_bowery');
        return false;
      });
    },
    
    dialog_chilewich: function() {   
      $('#chilewich').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#chilewich_opener').live('click', function() {
    	  Dialog.open('#chilewich');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#chilewich');
        return false;
      });
    },
    
    dialog_thornton: function() {   
      $('#thornton').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#thornton_opener').live('click', function() {
    	  Dialog.open('#thornton');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#thornton');
        return false;
      });
    },
    ...
    dialog_liz: function() {   
      ...
      $('#liz_opener').live('click', function() {
    	  Dialog.open('#liz');
        return false;
    	});
    ...
    dialog_citibabes: function() {   
      ...
      $('#citibabes_opener').live('click', function() {
    	  Dialog.open('#citibabes');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#citibabes');
        return false;
      });
    },
    
    dialog_mally_v1: function() {   
      $('#mally_v1').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#mally_v1_opener').live('click', function() {
    	  Dialog.open('#mally_v1');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#mally_v1');
        return false;
      });
    },
    
    dialog_kates: function() {   
      $('#kates').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#kates_opener').live('click', function() {
    	  Dialog.open('#kates');
        return false;
    	});
    ...
    dialog_kimara: function() {   
      ...
      $('#kimara_opener').live('click', function() {
    	  Dialog.open('#kimara');
        return false;
    	});
    ...
    dialog_sycamore: function() {   
      ...
      $('#sycamore_opener').live('click', function() {
    	  Dialog.open('#sycamore');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#sycamore');
        return false;
      });
    },
    
    dialog_walnut: function() {   
      $('#walnut').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#walnut_opener').live('click', function() {
    	  Dialog.open('#walnut');
        return false;
    	});
    ...
    dialog_walnut_shelves: function() {   
      $('#walnut_shelves').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      	width: 660,
      ...
      $('#walnut_shelves_opener').live('click', function() {
    	  Dialog.open('#walnut_shelves');
        return false;
    	});
    	
    	$('#js-close-modal').live('click', function() {
        Dialog.close('#walnut_shelves');
        return false;
      });
    },
    
    dialog_cherry: function() {   
      $('#cherry').dialog({
        autoOpen: false,
      	modal: true,
      	resizable: false,
      ...
      $('#cherry_opener').live('click', function() {
    	  Dialog.open('#cherry');
        return false;
    	});
